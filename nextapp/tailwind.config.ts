...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        gold: "0 0 20px rgba(160, 114, 10, 0.18), 0 0 40px rgba(160, 114, 10, 0.08)",
        "gold-strong": "0 0 30px rgba(160, 114, 10, 0.28), 0 0 60px rgba(160, 114, 10, 0.14)",
        "card": "0 8px 40px rgba(0,0,0,0.08), 0 0 0 1px rgba(160,114,10,0.1)",
        "card-hover": "0 20px 60px rgba(0,0,0,0.12), 0 0 0 1px rgba(160,114,10,0.2), 0 0 30px rgba(160,114,10,0.08)",
      },
      animation: {

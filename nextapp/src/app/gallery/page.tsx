...
const galleryItems = [
  ...
  },
  {
    ...
    size: '24 inches (61 cm)',
    description: 'A breathtaking assembly of the Shiva Parivar—Lord Shiva, Goddess Parvati, Lord Ganesha, and Lord Kartikeya. Hand-carved in Jaipur from premium White marble, highlighted with delicate gold leaf details and oil lamp reflections, radiating absolute domestic harmony and cosmic peace.',
  },
  {
    id: 7,

...
export const products: Product[] = [
  {
    ...
    height: "4 inches",
    weight: "0.4 kg",
    description: "4\" Small Smart Ganesha in White Marble Statue | Handcrafted sacred Ganesha",
    longDescription: "This exquisite 4-inch small Smart Ganesha in White Marble radiates a sense of wisdom and charm. Depicted in his classic seated form, Lord Ganesha, the remover of obstacles, is adorned with intricate and minute gold detailing, making it a perfect auspicious addition to your home temple, office desk, or as a premium gift.",
    images: [
      "/products/small-ganesha-hero.png"
    ],
    rating: 4.9,
    reviews: 16,
    inStock: true,
    badge: "Bestseller",
    category: "Marble",
    finish: "Polished White Marble with Gold Details",
    origin: "MADE IN INDIA",
    keywords: "small ganesha statue, 4 inch ganesha murti, buy white marble ganesha online, smart ganesha white marble, table ganesha idol, office desk ganesha, auspicious ganesha gift",
    purpose: "Auspicious Beginning, Office Desk, Home Mandir, Premium Gift",
    features: [
      "Pure White Marble",
